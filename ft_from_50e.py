...
if args.LM == 'Bert':
    ...
    model = XLMWithLMHeadModel.from_pretrained('./multi-label_LM/multi-label_XLM_e50_b16', config=config)
...
dir = str(args.resultpath) + str(args.data) + '_' + str(args.LM) + '_e100' + '_b' + str(args.batch_size)
